...
from .dataset import preprocess_tabular
...
def train_tabular_models():
    ...
    print(f"Tabular pitch_class accuracy: {acc_c:.4f}")
    model_class.save_model(str(TABULAR_MODEL_CLASS_PATH))
    print("Saved tabular class model to:", TABULAR_MODEL_CLASS_PATH)
    ...
    print(f"Tabular zone accuracy: {acc_z:.4f}")
    model_zone.save_model(str(TABULAR_MODEL_ZONE_PATH))
    print("Saved tabular zone model to:", TABULAR_MODEL_ZONE_PATH)
